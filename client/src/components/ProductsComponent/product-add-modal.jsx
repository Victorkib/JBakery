...
export const ProductAddModal = ({
  ...
  const [previewImages, setPreviewImages] = useState([
    '/placeholder.svg?height=400&width=400&text=Add+Main+Image',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const newProduct = {
        ...formData,
        id: Math.floor(Math.random() * 1000) + 10, // Simple ID generation for demo
    ...
    const templates = [
      {
        ...
        ingredients:
          'Flour, Sugar, Cocoa Powder, Eggs, Butter, Vanilla Extract',
      ...
      },
      {
        ...
        ingredients:
          'Flour, Sugar, Butter, Eggs, Vanilla Extract, Food Coloring',
        category: 'Cupcakes',
        price: 600,
      },
      {
        name: 'Chocolate Chip Cookies (Box of 12)',
        description: 'Classic chocolate chip cookies, freshly baked and chewy.',
        ingredients:
          'Flour, Sugar, Butter, Eggs, Chocolate Chips, Vanilla Extract',
        category: 'Cookies',
        price: 450,
      },
      {
        ...
        description:
          'Moist red velvet cake with cream cheese frosting and elegant decoration.',
        ingredients:
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`flex items-center gap-1 px-3 py-1.5 text-sm rounded-lg ${
                    theme === 'dark'
                      ? 'bg-purple-900/20 text-purple-400 hover:bg-purple-900/30 border border-purple-800/30'
                    ...
                    >
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          >
                            <li>
                              • Use descriptive names that include key product
                              features
                            </li>
                            <li>
                              • Add detailed descriptions to improve search
                              visibility
                            </li>
                            <li>
